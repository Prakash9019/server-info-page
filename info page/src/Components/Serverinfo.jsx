...
export default function ServerInfo() {
  ...
  return (
    <div className="flex flex-row max-md:max-w-full">
      <div className="flex flex-col items-center justify-center mt-2 w-[100px] h-full min-h-screen ">
       <img
          loading="lazy"
          src={image1}
          className="object-contain mt-2 w-7% aspect-square"
          alt="sdfsf"
        />
          <img
            loading="lazy"
          ...
          <img
            loading="lazy"
            src={image3}
            className="object-contain mt-2 mr-5 w-5% aspect-square"
            alt=""
          />
          <img
            loading="lazy"
      ...
      <div className="flex flex-col items-center mt-5 ml-5 max-w-full w-[1137px]">
        <div className="flex flex-wrap gap-10 items-start self-stretch w-full max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-between max-w-full text-xl text-white font-semibold tracking-widest whitespace-nowrap w-[286px]">
                  <div> 
                    <h4>PLAYERS</h4>
...
//   return (
//     <div className="flex flex-row items-start -mr-px max-md:max-w-full">
//       <div className="flex flex-col items-center justify-center mt-2 w-[100px] h-full">
//        <img
//           loading="lazy"
